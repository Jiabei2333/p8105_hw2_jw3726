...
```{r}
precipitation_2017 = readxl::read_excel("./HealthyHarborWaterWheelTotals2017-9-26.xlsx",sheet = 3 ) %>%
janitor::clean_names() 
  filter(!is.na(month))

precipitation_2016 = readxl::read_excel("./HealthyHarborWaterWheelTotals2017-9-26.xlsx",sheet = 4 ) %>%
janitor::clean_names() 
